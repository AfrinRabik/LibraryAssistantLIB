...
const AIChat = () => {
  ...
  return (
    <div className="container py-5 position-relative fade-in" style={{ height: 'calc(100vh - 150px)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="row justify-content-center flex-grow-1">
        <div className="col-xl-9 d-flex flex-column h-100">
          ...
          {/* Chat Header */}
          <div className="glass-card p-3 border-0 rounded-4 shadow-sm mb-3 d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <small className="text-success"><i className="bi bi-circle-fill" style={{ fontSize: '0.6rem' }}></i> Online & Syncing MySQL context</small>
            </div>
          </div>
            ...
            <div className="chat-container flex-grow-1 overflow-y-auto pr-2">
              {messages.map((msg) => (
                <div key={msg.id} className="d-flex flex-column mb-3">
                  ...
                  {/* Inline Book Recommendations (WOW factor!) */}
              ...
              {loading && (
                <div className="chat-bubble bot d-flex align-items-center gap-2">
                  ...
                  <span className="text-muted small ms-1">Assistant is checking database inventory...</span>
                </div>
              )}
          ...
          >
            <input 
              ...
              placeholder="Ask anything (e.g., Recommend spring boot books or What is borrow duration?)..."
              value={input}
